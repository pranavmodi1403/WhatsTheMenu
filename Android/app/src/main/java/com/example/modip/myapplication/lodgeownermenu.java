...
public class lodgeownermenu extends AppCompatActivity {
    TextView tv_menu,tv_address,tv_ltime,tv_dtime;
    String phone;
    int s;
    String lmenu="";
    String laddress="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lodgeownermenu);
        tv_menu=(TextView)findViewById(R.id.textView9);
        tv_address=(TextView)findViewById(R.id.textView11);
        tv_ltime=(TextView)findViewById(R.id.textView13);
        tv_dtime=(TextView)findViewById(R.id.textView47);
        new menudetail().execute(MainActivity.lodgeusername);
    }
    private class menudetail extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            try {
                phone=params[0];
                URL url=new URL(getString(R.string.php_url).concat("seemenulodgeowner.php"));
