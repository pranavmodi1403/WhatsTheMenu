...
public class seeorder extends AppCompatActivity implements OnClickListener {
    List orderlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addHeaders();
        new getorderdetails().execute(MainActivity.lodgeusername);
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(getBaseContext(),lodgeownermenudrawer.class));
    }

    public void addData() {
        int n=orderlist.size();
        TableLayout tl = (TableLayout) findViewById(R.id.seeordertable);
    ...
    public void addHeaders() {
        ...
        tr.addView(getTextView(0, "User Mobile Number", Color.BLACK, Typeface.BOLD,Color.parseColor("#a0522d")));
    ...
    public void onClick(View v) {
        ...
        if (null != tv) {
            o_id= (String) tv.getText();
            if(!o_id.equals("ID")) {
                startActivity(new Intent(getBaseContext(),orderdetail.class));
            }
        }
    }
    private class getorderdetails extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url=new URL(getString(R.string.php_url).concat("lodgeownerorders.php"));
                ...
                String post_data = URLEncoder.encode("lphone","UTF-8")+"="+URLEncoder.encode(lphone,"UTF-8")+"&";
